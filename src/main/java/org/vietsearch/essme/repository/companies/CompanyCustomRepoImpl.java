...
public class CompanyCustomRepoImpl implements CompanyCustomRepo {
    ...
    public List<Company> getCompanyByCountryIndustryAndRank(String country, String industry, String rank, boolean asc) {
        Sort sort =  Sort.by("ranks." + rank);
        sort = asc == true ? sort.ascending() : sort.descending();
